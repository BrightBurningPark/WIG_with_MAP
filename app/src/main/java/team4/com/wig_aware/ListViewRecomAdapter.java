...
public class ListViewRecomAdapter extends ArrayAdapter implements View.OnClickListener {
    // 버튼 클릭 이벤트를 위한 Listener 인터페이스 정의.
    public interface ListRecomClickListener {
    ...
    private ListRecomClickListener listRecomClickListener;


    // ListViewBtnAdapter 생성자. 마지막에 ListBtnClickListener 추가.
    public ListViewRecomAdapter(Context context, int resource, ArrayList<ListViewRecomItem> list, ListRecomClickListener clickListener) {
        super(context, resource, list);

        // resource id 값 복사. (super로 전달된 resource를 참조할 방법이 없음.)
        this.resourceId = resource;

        this.listRecomClickListener = clickListener;
    }
    ...
    public void onClick(View v) {
        ...
        if (this.listRecomClickListener != null) {
            this.listRecomClickListener.onListBtnClick((int)v.getTag());
        }
    }
}